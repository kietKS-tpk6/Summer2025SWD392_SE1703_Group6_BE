...
namespace Application.Usecases.CommandHandler
{
    public class AddTestSchedulesToSlotsCommandHandler : IRequestHandler<AddTestSchedulesToSlotsCommand, bool>
    {
        ...
        public AddTestSchedulesToSlotsCommandHandler(ISyllabusScheduleTestService syllabusScheduleTestService, IAssessmentCriteriaService assessmentCriteriaService, ISyllabusScheduleService syllabusScheduleService )
        {
